<?php 
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(isset($_FILES['file']['name']) && $_FILES['file']['name'] != "")
		{
			...
			if($_FILES['file']['type'] == "image/jpeg") //checking if file type is jpeg
			{
				...
				echo "Images of more than 3MB are not allowed!";
				echo "</div>";
				}
			}else
			{
				echo "<div style='text-align: center; font-size: 12px;color:white;background-color: grey;'>";
				echo "<br> The following errors occured: <br><br>";
				echo "Please upload an image of jpeg type!";
				echo "</div>";
				}
...
<!DOCTYPE html>
	...
	<head>
		<meta charset="utf-8">
		<title>Change Profile Image | Socion</title>
	</head>
